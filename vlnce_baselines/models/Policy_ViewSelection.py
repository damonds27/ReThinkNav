...
class CMANet(Net):
    ...
    def forward(self, mode=None,
        ...
        if mode == 'language':
            ...
            # print(f"waypoint_heatmap_logits shape: {waypoint_heatmap_logits.shape}")
            ...
            # print(f"cand_rgb shape: {cand_rgb.shape}")
            # print(f"cand_depth shape: {cand_depth.shape}")
            # print(f"cand_direction shape: {cand_direction.shape}")
            # print(f"cand_mask shape: {cand_mask.shape}")
            # print(f"candidate_lengths: {candidate_lengths}")
            # print(f"batch_angles: {batch_angles}")
            # print(f"batch_distances: {batch_distances}")
            if in_train:
